...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      offer: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`offer: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = this._offer_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData };
      }
    };
    this.impureCircuits = { offer: this.circuits.offer };
  }
  initialState(...args_0) {
    if (args_0.length !== 3) {
    ...
    const anItemName_0 = args_0[1];
    const aBasePrice_0 = args_0[2];
                    ...
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                            alignment: _descriptor_7.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(anItemName_0),
                                                                            alignment: _descriptor_6.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    Contract._query(context,
                    partialProofData,
